...
*/
		//Interface 기반 Programmin : java.sal.* 이용 DBMS 비종속적인 DB
		//1.단계 CONNECTION :: LOGIN과정
		//String driver = new BufferedReader(new FileReader("D:\\config\\db.txt")).readLine();
		//Class.forName(driver);
		//39번줄처럼 사용하면 DBMS에 비종속적인 프로그램이 된다.
